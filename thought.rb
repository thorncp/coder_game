class Thought
  ...
  @thoughts = [
    "Man, if I were designing a game about this craziness right now, I'd totally make the F key perform actions. (And Q to just give up)",
    "WTF is this door? Looks to be locked. Maybe I can hack it.",
    "Well that wasn't too bad. What worries me though is that door wasn't here last night...  It also appears I'm heading UP.",
    ...
    "HOLY CRAP. I just projected raw code from my mind. MY MIND! What the hell is this place and WTF did they do to me!? I'm also quite sure I just heard the sounds of a number incrementing.",
    "These guys are moving like cyborgs. Or perhaps it's just the natural movement of the managerial types."
  ]
